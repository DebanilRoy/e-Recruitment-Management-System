...
if target_card:
    ...
    # === Click "Reject" button ===
    reject_button = target_card.find_element(ChromeDriver.By.XPATH, ".//button[contains(text(),'Reject')]")
    reject_button.click()
    ...
    if "OFFER REJECTED" in notification.text.strip():
        print("Test Passed: Notification appeared after rejection.")
    else:
